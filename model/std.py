...
class StdModel(Query):
    ...
    def get_std_posts(self, num = 6, current_page = 1):
    ...
    def get_std_posts_by_channel_id(self, channel_id, num = 6, current_page = 1):
    ...
    def get_std_posts_by_user_id(self, user_id, num = 6, current_page = 1):
